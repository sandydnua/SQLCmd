...
<%
    ...
    StringBuilder form = new StringBuilder("<form action=\"create\" method \"get\">");
    ...
    form.append(String.format("<a  href=\"createtable.jsp?%s&fields=\" value=\"Create\">Добавить поле</a><p>", queryStr));
